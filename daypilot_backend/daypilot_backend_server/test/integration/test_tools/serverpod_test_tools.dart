...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:daypilot_backend_server/src/generated/greetings/greeting.dart'
    as _i5;
import 'package:daypilot_backend_server/src/protocol/plan_response.dart' as _i6;
import 'package:daypilot_backend_server/src/generated/protocol.dart';
import 'package:daypilot_backend_server/src/generated/endpoints.dart';
...
class _PlanEndpoint {
  ...
  _i3.Future<_i6.PlanResponse> generatePlan(
    _i1.TestSessionBuilder sessionBuilder,
    String rawTasks,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'rawTasks': rawTasks}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i6.PlanResponse>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
